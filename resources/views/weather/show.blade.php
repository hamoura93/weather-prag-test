            ...
            <div class="row">
                    @if(isset($data))
                        <div class="card1 col-lg-6 col-md-6">
                                    ...
                                    <div class="row px-3">
                                        <img class="weatherimg1" src="https://openweathermap.org/img/wn/{{  $weather_icon }}.png" alt="Weather Icon">
                                     </div>
                                     <div class="row px-3">
        ...
        <div class="forms">
          ...
          <div class="card1 col-lg-12 col-md-12">
                <div class="row px-3 mt-3 mb-3">
                    <h1 class="large-font mr-3">No weather information available.</h1>  
                    <div class="card-header">
                <h5 class="card-title">Current City: {{ $city_name}}</h5>
            </div>
            </div>
            <div class="row">
